    ...
    <View className="flex-1 bg-white px-6 pt-14">
      ...
      <View className="items-center mb-8">
        <View className="flex-row items-center">
          ...
          <Text className="text-[#1A1A1A] font-clash-bold text-[48px]">
            {formattedAmount()}
          </Text>
        </View>
      ...
      <View className="flex-1 justify-end pb-12">
        ...
        <TouchableOpacity
          ...
          className={`h-[52px] rounded-full items-center justify-center w-full mt-6 ${isValidAmount ? "bg-[#00D68F]" : "bg-[#00D68F]/40"}`}
        >
          <Text className="text-black font-clash-bold text-[16px]">Continue</Text>
        </TouchableOpacity>
      </View>
    </View>
  );
